        ...
        @if (Session::has('success'))
            <div id="toast-success" tabindex="-1"
                ...
                <div id="toast-success"
                    ...
                    <div class="ms-3 text-sm font-normal">Order Submited successfully.</div>
                    <button type="button"
        ...
        {{-- <livewire:pop-up-card> --}}
            ...
            <div id="toast-cart" tabindex="-1"
                ...
                <div id="toast-cart"
                    ...
                    <div class="ms-3 text-sm font-normal">Item added to cart successfully.</div>
                    <button type="button"
                        class="ms-auto -mx-1.5 -my-1.5 bg-white text-gray-400 hover:text-gray-900 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-gray-100 inline-flex items-center justify-center h-8 w-8 dark:text-gray-500 dark:hover:text-white dark:bg-gray-800 dark:hover:bg-gray-700"
                        data-dismiss-target="#toast-cart" aria-label="Close">
                        <span class="sr-only">Close</span>
                        <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                            viewBox="0 0 14 14">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
